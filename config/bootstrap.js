...
module.exports.bootstrap = function(done) {
  ...
  passport.use(new RegisterStrategy(verifyForRegister, registerLocal));

  function verifyLocal(username, password, next) {
    return sails.models.passport.verifyLocal(username, password, next);
  }

  function verifyForRegister(username, password, next) {
    return sails.models.passport.verifyForRegister(username, password, next);
  }

  function registerLocal(username, password, next) {
    return sails.models.passport.registerLocal(username, password, next);
  }
